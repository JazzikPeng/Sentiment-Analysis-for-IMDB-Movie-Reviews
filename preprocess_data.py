...
print('Total: ', np.sum(no_of_tokens), ' Min: ', 
    np.min(no_of_tokens), ' Max: ', np.max(no_of_tokens), ' Mean: ', 
    np.mean(no_of_tokens), ' Std: ', np.std(no_of_tokens))


### word_to_id and id_to_word. associate an id to every unique token in the training data
print('word_to_id and id_to_word')
...
print('Most Common 100 words', np.sum(count[0:100]))
print('Most Common 8000 words', np.sum(count[0:8000]))
...
# GloVe Features
print('Glove_Features preprocessing')
